...
public class B03_Scanner {
	...
	public static void main(String[] args) {
		...
		// Scanner의 nextInt() : 다음으로 들어오는 정수를 하나 꺼낸다
		//  - 다음으로 들어오는 정수를 하나 꺼낸다
		//  - 다음으로 꺼낼 값이 아무것도 없을 때는 입력을 계속 기다린다
		System.out.print("꼭 정수만 입력해 주세요(21억 이하) > ");
		int a = sc.nextInt();
		
		System.out.println("입력하신 값은 : " + a + "입니다");
		System.out.println("입력하신 값에 3 을 곱하면 : " + a * 3 + "입니다");
		...
		// Scanner의 next()
		// 	- 다음 단어를 String 타입으로 받아오기(공백, \t 기준)
		
		// Scanner의 nextLine() (\n 기준)
		// 	- 다음 한 줄을 String 타입으로 받아오기
