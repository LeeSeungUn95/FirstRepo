...
public class D03_Constructor {
	...
	public static void main(String[] args) {
		...
		System.out.println(orange_box[0].size);
		...
		orange_box[6] = new Orange(9, 10, new int[] { 235, 165, 0 });
...
class Orange{
	...
	//        생성자는 가장먼저 호출되기 때문에 주로 초기화 용도로 사용된다.
	Orange() {
...
// 아까 myobj에 만들었던 클래스에 알맞은 생성자를 2개 이상 추가해보세요
