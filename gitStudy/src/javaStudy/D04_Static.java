...
public class D04_Static {
	...
	public static void main(String[] args) {
		...
		// 아직 생성된 인스턴스가 없더라고 static 자원을 사용할 수 있다
		...
		System.out.println(JaceTower.floorHeight);
		JaceTower.changeHeight(300);
		System.out.println(JaceTower.floorHeight);
	}
}
...
class Lamp {
	...
	// static 영역에서 인스턴스 자원에 접근하는 것은 불가능
//	static void turnOn() {
//		this.powerOn = true;
//	}
}
