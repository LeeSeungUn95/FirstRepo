...
public class E02_HashSet {
	/*
	 	...
	 	* SHA256 (셈)
	 	 ...
	 	 hello+공백 -> 5e3235a8346e5a4585f8c58562f5052b8fe26a3bb122e1e96c76784964dfc461
	 */
	public static void main(String[] args) {
		...
		// ※ 컬렉션들을 배열로 변환하기
		Object[] arr1 = english.toArray(); // 1번 방법, Object[]를 생성
...
//		String str = (String) numbers3.get(3); // 자바 문법상으로는 아무 문제없음 - Error
